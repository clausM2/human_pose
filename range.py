...
def main():
    ...
    for i in range(len(files)):
        ...
        plt.figure(1)
        plt.scatter(x, anglelist[3], label="Hip", marker=".")
        plt.ylabel("Angle of joint")
        plt.xlabel("Frames")
        plt.title("Hip Angle Scatter Plot")

        plt.figure(2)
        plt.scatter(x, anglelist[4], label="Knee", marker=".")
        plt.ylabel("Angle of joint")
        plt.xlabel("Frames")
        plt.title("Knee Angle Scatter Plot")
